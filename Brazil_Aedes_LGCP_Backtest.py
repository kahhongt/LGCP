...
def log_poisson_likelihood_opt(param, *args):
    ...
    latent values - note that there are no hyper-parameters here to consider. The log-likelhood is taken as
     ...
     NOTE THAT THIS TABULATES THE FULL POISSON LIKELIHOOD, FOR ALL THE TERMS
...
log_poisson_likelihood = -1 * v_solution.fun
...
print('The optimal Log Poisson Likelihood is', log_poisson_likelihood)
