...
likelihood_frob.scatter(frob_norm, log_likelihood, marker='o', color='black', s=5)
...
likelihood_skew.scatter(element_skew, log_likelihood, marker='o', color='black', s=5)
...
avg_likelihood_frob.scatter(frob_norm, avg_log_likelihood, marker='o', color='black', s=5)
...
avg_likelihood_skew.scatter(element_skew, avg_log_likelihood, marker='o', color='black', s=5)
