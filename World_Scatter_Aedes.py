...
pp_world = world_scatter.scatter(world_x, world_y, marker='.', color='darkorange', s=0.1)
world_scatter.set_title('Global Aedes Occurrences from 1960 to 2014')
world_scatter.set_xlabel('UTM Horizontal Coordinate')
world_scatter.set_ylabel('UTM Vertical Coordinate')

world_fig = plt.figure()
world_scatter = world_fig.add_subplot(111)
pp_world = world_scatter.scatter(world_x, world_y, marker='.', color='black', s=0.1)
world_scatter.set_title('Global Aedes Occurrences from 1960 to 2014')
world_scatter.set_xlabel('UTM Horizontal Coordinate')
world_scatter.set_ylabel('UTM Vertical Coordinate')
...
pp_brazil_2014 = brazil_scatter_2014.scatter(x_2014, y_2014, marker='.', color='darkorange', s=0.1)
...
pp_brazil_2013 = brazil_scatter_2013.scatter(x_2013, y_2013, marker='.', color='darkorange', s=0.1)
